...
class Mysql {
    ...
    public static $_dbh = null; //静态属性,所有数据库实例共用,避免重复连接数据库
    public $_dbType = 'mysql';
    public $_pconnect = true; //是否使用长连接
    public $_host = 'localhost';
    public $_port = 3306;
    public $_user = 'root';
    public $_pass = 'root';
    public $_dbName = 'aiku_sso'; //数据库名
    public $_sql = true; //最后一条sql语句
    public $_where = '';
    public $_order = '';
    public $_limit = '';
    public $_field = '*';
    public $_clear = 0; //状态，0表示查询条件干净，1表示查询条件污染
    public $_trans = 0; //事务指令数
